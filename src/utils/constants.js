...
export const cardDeleteConfirmButton = document.querySelector('#button-delete-card');
export const profileUpdateAvatarOpenButton = document.querySelector('.profile__avatar-edit-button');
